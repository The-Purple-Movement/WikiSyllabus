...
# BComp-IS: Bachelor of Computing in Information Security (with Honours)

## Course Objectives
* To equip students with the skills to identify system vulnerabilities, develop robust security protocols, and respond effectively to security breaches.
* To provide a strong foundation in all relevant areas of computer science as they apply to information security.
* To deliver a comprehensive understanding of both the technical (cryptography, malware detection) and social (social engineering, security law) aspects of security.
* To prepare students for a career in the fast-growing field of information security, meeting the high demand for professionals who can safeguard organizational assets.

## Course Outcomes
* **CO 1:** Analyze systems to identify vulnerabilities and threats using both offensive and defensive security principles. *(Cognitive level: Analyze)*
* **CO 2:** Design and implement secure computer systems, networks, and applications to protect against cyber-attacks. *(Cognitive level: Create)*
* **CO 3:** Apply cryptographic theories and practices to secure data and communication systems effectively. *(Cognitive level: Apply)*
* **CO 4:** Evaluate security risks and manage information assets based on established cybersecurity management frameworks. *(Cognitive level: Evaluate)*
* **CO 5:** Understand and interpret the legal and ethical issues surrounding information security to ensure compliance and responsible practice. *(Cognitive level: Understand)*

## Course Content

### Module - 1 (Security Fundamentals)
* **CS2107 Introduction to Information Security:** Decipher the intricacies of IT security, exploring how websites are hacked, the limits of cryptography, and how human vulnerabilities are exploited.
* **CS3235 Computer Security:** Gain a broad understanding of security elements such as intrusion detection, e-mail security, and application, system, and network security.

### Module - 2 (Offensive Security and Penetration Testing)
* **IFS4103 Penetration Testing Practice:** Put on a “white hat” to ethically hack actual systems as part of a penetration testing team, learning from cybersecurity professionals how to scope and assess targets.

### Module - 3 (Cryptography and Secure Communications)
* **CS4236 Cryptography Theory and Practice:** Discover the principles and concepts behind cryptology and the design of secure communication systems, exploring the mathematics that underpins modern encryption.

### Module - 4 (Security Management and Law)
* **IS4231 Information Security Management:** Learn that effective cybersecurity is about risk management, including how to identify, prioritise, and defend valuable information assets.
* **IFS4101 Legal Aspects of Information Security:** Learn from an NUS Law professor how information security issues influence the law, covering topics like electronic signatures, SPAM, and data privacy.

## Resources and Further Information
1.  OAM Undergraduate Programmes
2.  Minor Programmes (e.g., with Faculty of Science in Financial Mathematics, Mathematics or Statistics)
3.  Minor Programmes (e.g., with NUS Business School in Management)
