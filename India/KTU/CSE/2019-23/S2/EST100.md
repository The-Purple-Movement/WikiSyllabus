...
- **CO2**: Identify and describe the components of systems of forces acting on rigid bodies.  
- **CO3**: Apply the conditions of equilibrium to various practical problems involving different force systems.  
- **CO4**: Choose appropriate theorems, principles, or formulae to solve problems in mechanics.  
- **CO5**: Solve problems involving rigid bodies by applying properties of distributed areas and masses.
